  ...
  ! function () {
          ...
          if (!r && (V(e), e = e || T, C)) {
              if (11 !== p && (u = L.exec(t)))
                  ...
                  if (c = t, f = e, 1 === p && (x.test(t) || m.test(t))) {
                      (f = H.test(t) && z(e.parentNode) || e) == e && le.scope || ((s = e.getAttribute("id")) ? s =
      ...
      function X(t) {
          return function (e) {
              return "form" in e ? e.parentNode && !1 === e.disabled ? "label" in e ? "label" in e.parentNode ?
                  ...
                  M(e) === t : e.disabled === t : "label" in e && e.disabled === t
          }
      }
      function U(a) {
          return F(function (o) {
      ...
      function V(e) {
          ...
          return n != T && 9 === n.nodeType && n.documentElement && (r = (T = n).documentElement, C = !ce.isXMLDoc(
                  T), i = r.matches || r.webkitMatchesSelector || r.msMatchesSelector, ye != T && (t = T.defaultView) &&
              t.top !== t && t.addEventListener("unload", R), le.getById = $(function (e) {
      ...
      function re(e, t, n, r) {
          ...
          if (n = n || [], 1 === c.length) {
              ...
              while (i--) {
                  ...
                  if ((u = b.find[s]) && (r = u(a.matches[0].replace(O, P), H.test(o[0].type) && z(t.parentNode) ||
                          t))) {
      ...
      G.prototype = b.filters = b.pseudos, b.setFilters = new G, le.sortStable = S.split("").sort(l).join("") ===
          ...
          re, I.setDocument = V, I.escape = ce.escapeSelector, I.getText = ce.text, I.isXML = ce.isXMLDoc, I.selectors =
  ...
  function V(e, t, n) {
      ...
      if (void 0 === n && 1 === e.nodeType)
          if (r = "data-" + t.replace(z, "-$&").toLowerCase(), "string" == typeof (n = e.getAttribute(r))) {
              try {
                  n = "true" === (i = n) || "false" !== i && ("null" === i ? null : i === +i + "" ? +i : U.test(i) ?
                      JSON.parse(i) : i)
              } catch (e) {}
              X.set(e, t, n)
          } else n = void 0;
          ...
          "content-box" === l.style.backgroundClip, ce.extend(le, {
              ...
              reliableTrDimensions: function () {
                  ...
                  return null == a && (e = C.createElement("table"), t = C.createElement("tr"), n = C
                      ...
                      parseInt(r.borderBottomWidth, 10) === t.offsetHeight, J.removeChild(e)), a
              }
          }))
  }();
      ...
      ce.cssHooks[u] = {
          get: function (e, t, n) {
              if (t) return !et.test(ce.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect()
                  .width ? ot(e, u, n) : ze(e, tt, function () {
                      return ot(e, u, n)
                  })
          },
          set: function (e, t, n) {
      ...
      ajax: function (e, t) {
          ...
          for (i in (g = ce.event && v.global) && 0 == ce.active++ && ce.event.trigger("ajaxStart"),
              ...
              T.setRequestHeader("Accept", v.dataTypes[0] && v.accepts[v.dataTypes[0]] ? v.accepts[v.dataTypes[
                  0]] + ("*" !== v.dataTypes[0] ? ", " + Xt + "; q=0.01" : "") : v.accepts["*"]), v.headers
